...
--
-- IMPORTANT:
-- This is a development database. Tax rules are stored as
...
(1, 1, 'System', 'Administrator', 'admin@taxsystem.local',
 '+2348000000001',
 '$2y$10$LK.N6htToJ9hECctWTuRY.2TDVbW0snKYuSumYZ4WTP8Ovz53uEB.',
 'ACTIVE'),

(2, 2, 'Revenue', 'Officer', 'officer@taxsystem.local',
 '+2348000000002',
 '$2y$10$Mmjy/DgkY/mrJTIRQkQAGeuUCvqtxwtPGcyN7iE8hIBA4cOq/s7me',
 'ACTIVE'),

(3, 3, 'Test', 'Taxpayer', 'taxpayer@taxsystem.local',
 '+2348000000003',
 '$2y$10$LO.yf2dMXZ0hSmSjaRgYsODL1f7H0GgfCnWuEsMoopMZF9UlCK7Dy',
 'ACTIVE');
...
VALUES
(1, 'Rent Relief',
 '20% of annual rent paid, subject to the statutory maximum of ₦500,000.',
...
--
-- Small company:
-- turnover <= ₦100m AND fixed assets <= ₦250m => 0% CIT
--
-- Other companies:
-- 30% CIT
--
...
--
-- The CBN MPR and applicable spread should be verified and updated
-- by the administrator when the relevant official rate is established.
-- This seed starts with zero interest until an administrator configures
-- the official rate for the deployment.
-- ------------------------------------------------------------
